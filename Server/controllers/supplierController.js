...
const getSuppliers = async (req, res) => {
    try {
        ...
        return res.status(500).json({ success: false, message: 'Server error is getting suppliers' });
    }
}
...
const updateSupplier = async (req,res) => {
    try {
        ...
        return res.status(500).json({ success: false, message: 'Server error while updating supplier' });
    }
}
...
const deleteSupplier = async (req, res) => {
    try {
        ...
        return res.status(500).json({ success: false, message: 'Server error while deleting supplier' });
    }
}
