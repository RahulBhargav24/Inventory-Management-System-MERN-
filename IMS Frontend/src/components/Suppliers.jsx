...
const Suppliers = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    //  console.error("Error editing supplier try:", response.data);
      alert("Error editing supplier. please try again.");
    }
   } catch (error) {
   //   console.error("Error editing supplier catch:", error.message)
         alert("Error editing supplier. Please try again.");
        }
    ...
    //  console.error("Error adding supplier try:", response.data);
      alert("Error adding supplier. please try again.");
    }
   } catch (error) {
   //   console.error("Error adding supplier catch:", error.message)
         alert("Error adding supplier. Please try again.");
        }
 }
    };
      ...
      {addModal && (
        <div className="fixed top-0 left-0 w-full h-full bg-black/50 flex justify-center items-center">
          <div className="bg-white p-4 rounded shadow-md w-1/3 relative">
            <h1 className="text-x1 font-bold">Add Supplier</h1>
            <button
